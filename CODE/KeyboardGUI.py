...
class BOBsHeart:
    def __init__(self):
        ...
        self.keysounds = {'Key.DIGIT_1': 'Sound Files/Pure Keys/C3.wav',
                        ...
                        'Key.Q': 'Sound Files/Pure Keys/C3.wav',
                        'Key.W': 'Sound Files/Pure Keys/D3.wav',
                        'Key.E': 'Sound Files/Pure Keys/E3.wav',
                        'Key.R': 'Sound Files/Pure Keys/f3.wav',
                        'Key.T': 'Sound Files/Pure Keys/G3.wav',
                        'Key.Y': 'Sound Files/Pure Keys/A3.wav',
                        'Key.U': 'Sound Files/Pure Keys/B3.wav',
                        'Key.I': 'Sound Files/Pure Keys/c4.wav',
                        'Key.O': 'Sound Files/Pure Keys/D4.wav',
                        'Key.P': 'Sound Files/Pure Keys/D4_2.wav',
